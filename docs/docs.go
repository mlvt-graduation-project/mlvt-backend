...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "users",
                        "schema": {
                            "$ref": "#/definitions/response.PremiumUsersResponse"
                        }
                    },
                    "500": {
                        "description": "server error",
        ...
        "/premium/{user_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "example: {\\\"premium\\\": true}",
                        "schema": {
                            "type": "object",
        ...
        "/progress/{user_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A JSON object containing progress data. Key: 'progresses'",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "claims",
                        "schema": {
                            "$ref": "#/definitions/response.DailyTokenClaimsResponse"
                        }
                    },
                    "500": {
                        "description": "server error",
        ...
        "/token/premium": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "not premium or already claimed",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
        ...
        "/wallet/balance": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Example: {\"balance\": 100}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "integer"
        ...
        "/wallet/use-token": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid user ID, amount, or insufficient balance",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "response.DailyTokenClaimsResponse": {
            "type": "object",
            "properties": {
                "claims": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.TokenClaim"
                    }
                }
            }
        },
        ...
        "response.PremiumUsersResponse": {
            "type": "object",
            "properties": {
                "users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.PremiumUser"
                    }
                }
            }
        },
