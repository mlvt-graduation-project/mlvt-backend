...
type transcriptionService struct {
	repo     transcription_repo.TranscriptionRepository
	s3Client aws.S3ClientInterface
}

func NewTranscriptionService(repo transcription_repo.TranscriptionRepository, s3Client aws.S3ClientInterface) TranscriptionService {
